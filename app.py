...
def premium_illustration(kind):
    se tipo == "logotipo":
        ...
        tentar:
            ...
            retornar f"<div class='vmb-illustration'><img src='data:image/png;base64,{data}' style='width:100%; max-width:280px; filter: drop-shadow(0 10px 20px rgba(0,0,0,0.3));'></div>"
        exceto:
    ...
    se st.session_state.page == "Home":
        ...
        tentar:
            ...
            <div class='vmb-metrics-grid'>
                ...
                {premium_metric_card("Melhor Nota", f"{max_score:.1f}%", "registro pessoal")}
