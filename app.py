...
def premium_illustration(kind):
    if kind == "logo":
        ...
        try:
            ...
            return f"<div class='vmb-illustration'><img src='data:image/png;base64,{data}' style='width:100%; max-width:280px; filter: drop-shadow(0 10px 20px rgba(0,0,0,0.3));'></div>"
        except:
    ...
    if st.session_state.page == "Home":
        ...
        try:
            ...
            """.format(
                ...
                premium_metric_card("Melhor Nota", "{0:.1f}%".format(max_score), "recorde pessoal"),
